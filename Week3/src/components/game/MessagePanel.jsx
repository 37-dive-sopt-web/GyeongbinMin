const MessagePanel = ({ gameStatus, guideMessage }) => {
  ...
  if (guideMessage) message = guideMessage;

  return (
    <div className="bg-white rounded-lg p-3 border">
      <div className="text-sm font-semibold mb-2">안내 메시지</div>
      <div className={`text-sm ${guideMessage ? "text-red-600 font-medium" : "text-gray-700"}`}>
        {message}
      </div>
    </div>
  );
